          ...
          <div className="flex gap-4">
            {config.instagram && (
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white/60 hover:text-flamingo hover:border-flamingo/50 hover:bg-flamingo/10 transition-all"
              >
                <svg
                  className="w-4 h-4"
                  viewBox="0 0 24 24"
            ...
            {config.whatsapp && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white/60 hover:text-green-400 hover:border-green-400/50 hover:bg-green-400/10 transition-all"
              >
                <svg
                  className="w-4 h-4"
                  viewBox="0 0 24 24"
